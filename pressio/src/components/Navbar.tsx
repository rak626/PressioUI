...
const Navbar = () => {
  ...
  return (
    <nav className="w-full z-40 px-6 py-2 flex items-center justify-between gap-8 bg-gradient-to-r from-[rgb(119,219,212)]  to-[rgb(131,157,223)] lg:justify-around">
      {/* logo section */}
